...
1. Explain what a token is used for.
   ...
   -A token is used to make sure the client is who they say they are, based off of the credentials they provided.

2. What steps can you take in your web apps to keep your data secure?

   -Use HTTPS, avoid vulnerablities with packages, and avoid bad practice when handling sensitive user data.

3. Describe how web servers work.

   -Web servers host code that can be used to create an api or a website. They can be built upon any modern PC, or hosted on a computer specifically made to host web servers.

4. Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

   -Create, read, post/put, and delete.
